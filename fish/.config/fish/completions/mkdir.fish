# mkdir
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/mkdir.1
complete -c mkdir -l mode -d 'set file mode (as in chmod), not a=rwx - umask'
complete -c mkdir -l parents -d 'no error if existing, make parent directories as needed, with their file mode…'
complete -c mkdir -l verbose -d 'print a message for each created directory'
