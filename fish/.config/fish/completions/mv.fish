# mv
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/mv.1
...
complete -c mv -l force -d 'do not prompt before overwriting'
complete -c mv -l interactive -d 'prompt before overwrite'
complete -c mv -l no-clobber -d 'do not overwrite an existing file '
...
complete -c mv -l verbose -d 'explain what is being done'
