# mkfifo
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/mkfifo.1
complete -c mkfifo -l mode -d 'set file permission bits to MODE, not a=rw - umask'
