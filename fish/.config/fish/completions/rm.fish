# rm
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/rm.1
complete -c rm -l force -d 'ignore nonexistent files and arguments, never prompt'
...
complete -c rm -l recursive -d 'remove directories and their contents recursively'
complete -c rm -l dir -d 'remove empty directories'
complete -c rm -l verbose -d 'explain what is being done'
