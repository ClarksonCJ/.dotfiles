# kubectl-annotate
# Autogenerated from man page /usr/local/share/man/man1/kubectl-annotate.1
...
complete -c kubectl-annotate -s l -l selector -d '	Selector (label query) to filter on, supports \'=\', \'==\', and \'!=\'. (e. g'
