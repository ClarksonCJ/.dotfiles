# split
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/split.1
complete -c split -l suffix-length -d 'generate suffixes of length N (default 2)'
complete -c split -l additional-suffix -d 'append an additional SUFFIX to file names'
complete -c split -l bytes -d 'put SIZE bytes per output file'
...
complete -c split -l lines -d 'put NUMBER lines/records per output file'
complete -c split -l number -d 'generate CHUNKS output files; see explanation below'
