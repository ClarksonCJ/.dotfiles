# stty
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/stty.1
complete -c stty -l all -d 'print all current settings in human-readable form'
complete -c stty -l save -d 'print all current settings in a stty-readable form'
...
complete -c stty -o isig -o ixany -o imaxbel
complete -c stty -o iutf8 -o ocrnl -d 'opost -ofill onlcr -onocr -onlret nl0 cr0 tab0 bs0 vt0 ff0 isig -tostop -ofde…'
