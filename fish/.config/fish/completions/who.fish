# who
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/who.1
complete -c who -l all -d 'same as -b -d --login -p -r -t -T -u'
complete -c who -l boot -d 'time of last system boot'
complete -c who -s d -l dead -d 'print dead processes'
complete -c who -l heading -d 'print line of column headings'
...
complete -c who -l count -d 'all login names and number of users logged on'
complete -c who -s r -l runlevel -d 'print current runlevel'
complete -c who -l short -d 'print only name, line, and time (default)'
complete -c who -s t -l time -d 'print last system clock change'
complete -c who -s w -l mesg -d 'add user\'s message status as +, - or ?'
complete -c who -l users -d 'list users logged in'
