# stat
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/stat.1
complete -c stat -l dereference -d 'follow links'
complete -c stat -l file-system -d 'display file system status instead of file status'
...
complete -c stat -l terse -d 'print the information in terse form'
