# tail
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/tail.1
complete -c tail -l bytes -d 'output the last NUM bytes; or use -c +NUM to output starting with byte NUM of…'
complete -c tail -l follow -d 'output appended data as the file grows; P an absent option argument means \'de…'
complete -c tail -l lines -d 'output the last NUM lines, instead of the last 10; or use -n +NUM to skip NUM…'
...
complete -c tail -l quiet -l silent -d 'never output headers giving file names'
...
complete -c tail -l verbose -d 'always output headers giving file names'
