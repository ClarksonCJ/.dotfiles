# mknod
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/mknod.1
complete -c mknod -l mode -d 'set file permission bits to MODE, not a=rw - umask'
