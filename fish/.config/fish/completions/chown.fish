# chown
# Autogenerated from man page /usr/local/opt/coreutils/libexec/gnuman/man1/chown.1
complete -c chown -s c -l changes -d 'like verbose but report only when a change is made'
complete -c chown -l silent -l quiet -d 'suppress most error messages'
complete -c chown -l verbose -d 'output a diagnostic for every file processed'
complete -c chown -l dereference -d 'affect the referent of each symbolic link (this is the default), rather than …'
complete -c chown -l no-dereference -d 'affect symbolic links instead of any referenced file (useful only on systems …'
...
complete -c chown -l recursive -d 'operate on files and directories recursively '
